...
constexpr int ScreenScalingFactor = 2;  //credits for this trick to @MAX#2223

constexpr int BufferWidth = 480;
constexpr int BufferHeight = 480;

constexpr int ScreenWidth = 480 * ScreenScalingFactor;
constexpr int ScreenHeight = 480 * ScreenScalingFactor;
// #define FULLSCREEN
...
static const char* GameName = "Clear The Dungeon";
